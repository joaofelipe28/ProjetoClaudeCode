...
export function Mensal() {
  const {
    ...
    addPontual, updatePontual, deletePontual, addCategoria, updateFixo, updateParcelamento,
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <CategoriaChip value={f.categoria} categorias={categorias} onCreate={addCategoria} onChange={v => updateFixo(f.id, { categoria: v })} />
                    </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <CategoriaChip value={p.categoria ?? ''} prefix={p.tipo} categorias={categorias} onCreate={addCategoria} onChange={v => updateParcelamento(p.id, { categoria: v })} />
                    </div>
